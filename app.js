$(document).ready(function () {
  ...
  $(document).ready(function () {
    ...
    $.get(
      `https://diwserver.vps.webdock.cloud/products/category/Accessories - Eyewear/${productId}`,
      function (product) {
...
$(document).ready(function () {
  ...
  $.ajax({
    url: 'https://diwserver.vps.webdock.cloud/products/category/Accessories - Eyewear?page=37',
    method: 'GET',
    success: function (response) {
